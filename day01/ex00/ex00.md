...
```
If not, feel free to look at the doc :) (or ask your neighbours, or google...) [Elasticsearch setup](https://www.elastic.co/guide/en/elasticsearch/reference/current/setup.html).
