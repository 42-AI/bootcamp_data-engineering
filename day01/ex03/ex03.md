...
So by now you already know that mapping a field as a keyword or as a text make a big difference. This is because Elasticsearch analyses all the text fields at ingest so the textcan be easier to search. 
